...
class RegularizeConvNetwork:
    ...
    def regularize_weights_orthogonality(self, model, layer, penalty):
        ...
        difference_matrix = torch.sub(gram_matrix, identity_matrix)
        score = penalty * torch.norm(difference_matrix, p='fro')
        return score
